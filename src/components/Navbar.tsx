...
const Navbar: React.FC<NavbarProps> = ({ toggleSidebar }) => {
  ...
  return (
    <nav className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-30 dark:bg-gray-900 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
                        ...
                        <li className="row-span-1">
                          <NavigationMenuLink asChild>
                            <Link 
                              ...
                              className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-4 hover:bg-accent"
                            >
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                <span className="text-sm text-gray-600 dark:text-gray-300 hidden sm:inline-block">Hi, {user.name}</span>
                <Button 
                  variant="ghost" 
                  size="sm" 
        ...
        <div className={cn(
          ...
          <div className="p-5">
            ...
            <div className="space-y-4">
              ...
              {user && (
                <Link to={`/${user.role}/profile`} onClick={() => setMobileMenuOpen(false)} className="block py-2 px-4 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800">
                  <div className="flex items-center">
